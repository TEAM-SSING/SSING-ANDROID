...
val ApiException.uiMessage: String
    get() = when (this) {
        is BusinessException -> this.message ?: "알 수 없는 오류가 발생했어요."
        is ApiException.BadRequest -> this.message ?: "잘못된 요청이에요."
        is ApiException.Conflict -> this.message ?: "요청을 처리할 수 없어요."
        ...
        is ApiException.NotFound -> this.message ?: "요청한 정보를 찾을 수 없어요."
