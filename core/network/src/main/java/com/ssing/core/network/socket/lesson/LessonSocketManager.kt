...
internal class LessonSocketManager @Inject constructor(
    client: StompClient,
    tokenAccessManager: TokenAccessManager,
    tokenReissueManager: TokenReissueManager,
    authSessionManager: AuthSessionManager,
    json: Json,
) : BaseSocketManager<LessonEnvelope<JsonElement>>(
    ...
    authSessionManager = authSessionManager,
    json = json,
    serializer = LessonEnvelope.serializer(JsonElement.serializer()),
) {
    override val destination: String = "/user/queue/lesson"
}
