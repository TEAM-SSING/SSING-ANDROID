...
import com.ssing.data.consumerhome.remote.datasource.impl.ConsumerHomeRemoteDataSourceImpl
import dagger.Binds
...
internal abstract class ConsumerHomeDataSourceModule {

    @Binds
    @Singleton
    abstract fun bindConsumerHomeDataSource(
        impl: ConsumerHomeRemoteDataSourceImpl,
