...
@Serializable
internal data class InstructorLessonDetailCanceledResponse(
    @SerialName("lessonId") val lessonId: Long,
    @SerialName("lessonStatus") val lessonStatus: LessonStatus,
    @SerialName("cancelInfo") val cancelInfo: CancelInfo,
    ...
    internal data class CancelInfo(
        ...
        @SerialName("canceledBy") val canceledBy: CanceledBy,
        @SerialName("cancelReason") val cancelReason: String,
    )

    @Serializable
    internal data class CanceledBy(
